...
import OrdenesPagos from "./Tables/OrdenesPagos";
import PAGOS from "./mocks/pagos";
        ...
        <div className="container d-flex align-items-center justify-content-between">
          ...
          <nav id="navbar" className="navbar">
            <ul>
              ...
              <li><Link to="/pagos" className="nav-link scrollto active">Pagos</Link></li>
